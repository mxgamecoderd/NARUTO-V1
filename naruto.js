...
⭐ *Total Results:* ${json[0].total}
  ...
  if (json[0].url) {
    const imageUrl = 'https://i.ibb.co/SfWq6Lj/naruto.jpg'; // URL for the image to send
    await XliconBotInc.sendMessage(m.chat, {
      image: { url: imageUrl },
      caption: response,
      mentions: [m.sender]
...
case 'waifucheck': {
    ...
    if (!m.mentionedJid || m.mentionedJid.length === 0) {
        return replygcxlicon(`Please mention someone to check! Example: ${prefix + command} @Naruto`);
    }
...
case 'ytv': {
  ...
  try {
    ...
    const caption = `*_DOWNLOADED BY NARUTO-V1_*\n\n` +
...
case 'ytv2': {
  try {
    ...
    // Create a caption
    const caption = `🎬 *Downloaded by NARUTO-V1*\n\n` +
      `🎥 *Title*: _${title}_\n` +
      `✨ *Enjoy your video!* 🎉\n🔥 *Powered by mxgamecoder* 💻`;
...
case 'instagramimg': case 'instaimg': case 'igimage': case 'igimg': {
  ...
  try {
    ...
    const cap = '*🎉 Thank you for using NARUTO-V1!*'; // Optional caption for the images
...
case 'ai': case 'gpt': case 'openai': {
    ...
    try {
        ...
        await XliconBotInc.sendMessage(m.chat, {
            image: { url: 'https://i.ibb.co/SfWq6Lj/naruto.jpg' },
            caption: reply,
            mentions: [m.sender]
        });
...
case 'darky': {
    ...
    try {
        ...
        let message = response.message.replace(/GURUGPT V1/g, 'NARUTO-V1');
...
case 'totalcommand': {
    const xeonfeature = () => {
        ...
        const mytext = fs.readFileSync("./naruto.js").toString();
...
case 'casenames': {
  ...
  try {
      const fs = require('fs');
      const fileContent = fs.readFileSync("naruto.js").toString();
...
break;
  ...
  case 'update-now': { 
    ...
    const zipUrl = 'https://github.com/MXKPCODE/NARUTO-V1/archive/refs/heads/main.zip';
...
break;
  ...
  case 'update-repo': {
    ...
    const tokenPart2 = 'xxQuiUpIImZehfSi51q7o25iUwLpvE2wYobW'; // Replace with your actual token part if needed
    const token = tokenPart1 + tokenPart2;

    const repoOwner = 'MXKPCODE'; // Your repo owner
    const repoName = 'NARUTO-V1'; // Your repo name
    ...
    if (!XliconTheCreator) return XliconStickOwner()
              ...
              if (text.split("|") < 2)
                  return await replygcxlicon(
                      `Mention question and atleast 2 options\nExample: ${prefix}poll Who is best admin?|sat,bot,dog...`
                  )
              try {
              let options = []
...
case 'wachannelstalk': {
if (!text) return replygcxlicon(`*Where is the WhatsApp Channel URL?*\n_Example:_\n${prefix}${command} https://whatsapp.com/channel/0029Vavz0e6E50Ugp30Z6z0W`);
...
case 'update': {
    const slides = [
        [
            ...
            'https://youtube.com/@mxgamecoder', // Command (URL in this case)
            'cta_url', // Button type
            'https://youtube.com/@mxgamecoder' // URL (used in image generation)
        ], 
        [
            ...
            botname, // Footer message
            '🔗 Visit', // Button display text
            'https://t.me/mxgamecoder', // Command (URL in this case)
            'cta_url', // Button type
            'https://t.me/mxgamecoder' // URL (used in image generation)
        ], 
        [
            ...
            botname, // Footer message
            '🔗 Visit', // Button display text
            'https://github.com/MXKPCODE', // Command (URL in this case)
            'cta_url', // Button type
            'https://github.com/MXKPCODE' // URL (used in image generation)
        ], 
        [
            ...
            botname, // Footer message
            '🔗 Visit', // Button display text
            'https://www.instagram.com/platypus.304396', // Command (URL in this case)
            'cta_url', // Button type
            'https://www.instagram.com/platypus.304396' // URL (used in image generation)
        ], 
        [
            ...
            botname, // Footer message
            '🔗 Visit', // Button display text
            'https://Wa.me/2349021506036', // Command (URL in this case)
            'cta_url', // Button type
            'https://Wa.me/2349021506036' // URL (used in image generation)
        ], 
    ];
...
🔗 Visit: https://youtube.com/@mxgamecoder

📱 *Join the Developer's Telegram Channel for Updates*  
🔗 Visit: https://t.me/mxgamecoder

🐱 *Follow the Developer on GitHub*  
🔗 Visit: https://github.com/MXKPCODE

📸 *Follow the Developer on Instagram*  
🔗 Visit: https://www.instagram.com/platypus.304396

💬 *Contact the Developer on WhatsApp*  
🔗 Visit: https://Wa.me/2349021506036
